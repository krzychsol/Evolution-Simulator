...
public class StatTracker implements IAnimalDeathObserver {
    ...
    public void saveStatsToFile(int mapNumber) throws IOException {
        ...
        try (Writer writer = new BufferedWriter(new OutputStreamWriter(
            ...
            writer.write("Map stats for day " + dayNumber + "\n");
            writer.write("Average number of animals: " + df.format((double) sumOfAnimalsEveryDay / dayNumber) + "\n");
            writer.write("Average number of grasses: " + df.format((double) sumOfGrassesEveryDay / dayNumber) + "\n");
            writer.write("Most frequent genotype: " + this.getMostFrequentGenotype() + "\n");
            writer.write("Average Life time of dead animals: " + df.format(getAverageLifeTime()) + "\n");

            // values below are average of average values
