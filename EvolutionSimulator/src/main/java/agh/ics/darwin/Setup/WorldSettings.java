...
public class WorldSettings {
    ...
    protected void validateJson(JSONObject jsonObj) throws IllegalArgumentException{
    ...
    protected void checkExistence(String arg, JSONObject jsonObj) throws IllegalArgumentException {
    ...
    protected void checkIfEqualOrGreater(int var, int required, String varName){
        if(var < required)
