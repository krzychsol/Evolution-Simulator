package agh.ics.darwin.Objects;

import agh.ics.darwin.Map.IEnergyChangeObserver;
import agh.ics.darwin.Map.IPositionChangeObserver;
import agh.ics.darwin.Math.MoveDirection;
import agh.ics.darwin.Math.Vector2d;
import agh.ics.darwin.Map.JungleMap;
import agh.ics.darwin.Simulation.IAnimalDeathObserver;
