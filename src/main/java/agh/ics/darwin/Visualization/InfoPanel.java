...
import agh.ics.darwin.Simulation.AnimalTracker;
import agh.ics.darwin.Simulation.SimulationEngine;
import agh.ics.darwin.Simulation.StatTracker;
...
public class InfoPanel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawImage(ColorsAndFonts.getBackgroundImage(), 0, 0, null);
